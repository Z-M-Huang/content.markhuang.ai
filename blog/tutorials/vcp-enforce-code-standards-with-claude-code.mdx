...
[Vibe Coding Protocol (VCP)](https://github.com/Z-M-Huang/vcp) is an open-source Claude Code plugin that enforces 40 security, architecture, and quality standards across 12 technology scopes — not as a linter you run after the fact, but as a three-layer system that prevents bad code before it reaches disk.
...
The source code and full documentation are on [GitHub](https://github.com/Z-M-Huang/vcp).
